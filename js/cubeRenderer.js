...
export function renderMap(list) {
    console.log(
        `${printLineList()}${printLineList(list[0], 0)}${printLineList()}`,
        `\n${printLineList()}${printLineList(list[0], 1)}${printLineList()}`,
        `\n${printLineList()}${printLineList(list[0], 2)}${printLineList()}`,
        `\n${printLineList(list[3], 0)}${printLineList(list[1], 0)}${printLineList(list[2], 0)}`,
        `\n${printLineList(list[3], 1)}${printLineList(list[1], 1)}${printLineList(list[2], 1)}`,
        `\n${printLineList(list[3], 2)}${printLineList(list[1], 2)}${printLineList(list[2], 2)}`,
